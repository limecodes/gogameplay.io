...
class BasicOperationTest extends TestCase
{
     ...
     * @test
     */
    public function shouldRecordVisitorIOSUnknownConnection()
    {
        // $this->withoutExceptionHandling();

        // $game = factory(Game::class)->create();

        // $response = $this->post('/game/'.$game->name, ['connection' => 'unknown'], ['HTTP_GGP_TEST_IP' => '1.1.1.4', 'HTTP_USER_AGENT' => 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.5 Mobile/15E148 Safari/604.1']);
        // $this->assertDatabaseHas('visitors', ['ip_address' => '1.1.1.4', 'device' => 'ios', 'mobile_connection' => false]);
    }
}
